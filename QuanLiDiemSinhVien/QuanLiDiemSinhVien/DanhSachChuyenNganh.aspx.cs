...
{
    public partial class DanhSachChuyenNganh : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        cls_con.connect_DB();
                        string st_sql = "SELECT * FROM tbl_chuyennganh order by Macn; ";
                        ...
                        {
                            i++;
                            st_kq = st_kq + "<tr><td>" + i + "</td><td>" + re[0].ToString() + "</td><td>" + re[1].ToString() + "</td><td>" + re[2].ToString() + "</td><tr>";
                        }
                        re.Close();
                        ltr_cn.Text = st_kq;
        ...
        protected void timkiem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string st_sql = "SELECT * FROM tbl_chuyennganh where Macn like '%'+ @key +'%' or lower(Tencn) like N'%' + @key + '%'   order by Macn";
